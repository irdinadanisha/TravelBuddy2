...
DEFAULT_SESSION_DIR = Path(__file__).resolve().parents[1] / "data" / "sessions"
SESSION_DIR = Path(
    os.getenv(
        "TRAVELBUDDY_SESSION_DIR",
        "/tmp/travelbuddy-sessions" if os.getenv("VERCEL") else str(DEFAULT_SESSION_DIR),
    )
)
